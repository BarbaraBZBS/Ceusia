...
export default function HomeFollows(props) {
	...
	return (
		<section className="w-full flex flex-col justify-start">
			<div className="w-fit text-clamp2 bg-appmauvedark px-[0.8rem] py-[0.4rem] border-2 border-appmauvedark rounded-xl mb-[1.2rem] leading-none text-white shadow-neatcard">
