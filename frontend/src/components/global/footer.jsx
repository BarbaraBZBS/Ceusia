...
export default function Footer() {
	return (
		<footer
			id="footer-container"
			className="mt-auto bg-gray-200 bg-opacity-60 flex flex-col text-appmagenta">
			...
			<div className="text-clamp2 mx-[2.8rem] text-center">
				<p>
			...
			<nav className="my-[0.8rem] flex flex-col justify-center items-center text-clamp2">
